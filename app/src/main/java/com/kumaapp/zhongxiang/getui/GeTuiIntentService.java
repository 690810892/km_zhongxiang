package com.kumaapp.zhongxiang.getui;
...
import static com.kumaapp.zhongxiang.EventBusConfig.NEW_MESSAGE;
import static com.kumaapp.zhongxiang.EventBusConfig.PUSH_TYPE;
...
public class GeTuiIntentService extends GTIntentService {
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage gtTransmitMessage) {
        ...
        if (payload == null) {
            ...
            EventBus.getDefault().post(new EventBusModel(PUSH_TYPE,keyType));
            mynotify(context);
