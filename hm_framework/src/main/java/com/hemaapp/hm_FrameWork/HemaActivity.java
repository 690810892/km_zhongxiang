...
import com.hemaapp.hm_FrameWork.dialog.ZysProgressDialog;
...
public abstract class HemaActivity extends XtomActivity {
    ...
    private ZysProgressDialog zysProgressDialog;
    /**
     * 关闭Activity
     *
    ...
    public void showZysProgressDialog(String text) {
        if (zysProgressDialog == null)
            zysProgressDialog = new ZysProgressDialog(this);
        zysProgressDialog.setText(text);
        zysProgressDialog.setCancelable(false);
        zysProgressDialog.show();
    }
    /**
     * 显示交互弹窗
     *
    ...
    public void cancelZysProgressDialog() {
        if (zysProgressDialog != null) {
            zysProgressDialog.setCancelable(false);
            zysProgressDialog.cancel();
        }
    }
    /**
     * 显示提示弹窗
    ...
    public void finish() {
        ...
        if (zysProgressDialog != null)
            zysProgressDialog.cancelImmediately();
        super.finish();
    }
